...
const char* ssid = "MTN_4G_312D8B";
const char* password = "56DB44AF";
const char* chatgpt_token = "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";
...
//   WiFi.disconnect();
//   WiFi.mode(WIFI_STA);
//   WiFi.begin( "MTN_4G_312D8B", "56DB44AF");
...
//   audio.setPinout(I2S_BCLK, I2S_LRC, I2S_DOUT);
//   audio.setVolume(100);
//   audio.connecttospeech("Hello Mr Kingsley,Thank you for making me use your network  ", "en"); // Google TTS
// }
