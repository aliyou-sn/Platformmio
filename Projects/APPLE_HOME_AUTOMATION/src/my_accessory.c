...
homekit_characteristic_t cha_name = HOMEKIT_CHARACTERISTIC_(NAME, "Aliyu Upwork");
...
homekit_accessory_t *accessories[] = {
    ...
    HOMEKIT_ACCESSORY(.id=1, .category=homekit_accessory_category_switch, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            ...
            HOMEKIT_CHARACTERISTIC(MANUFACTURER, "Aliyu"),
    ...
    HOMEKIT_SERVICE(SWITCH, .primary=true, .characteristics=(homekit_characteristic_t*[]){
     ...
     HOMEKIT_ACCESSORY(.id=5, .category=homekit_accessory_category_switch, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "Switch5"),
            HOMEKIT_CHARACTERISTIC(MANUFACTURER, "Aliyu"),
            HOMEKIT_CHARACTERISTIC(SERIAL_NUMBER, "0123456"),
            HOMEKIT_CHARACTERISTIC(MODEL, "1.0"),
            HOMEKIT_CHARACTERISTIC(FIRMWARE_REVISION, "1.0"),
    ...
    HOMEKIT_SERVICE(SWITCH, .primary=true, .characteristics=(homekit_characteristic_t*[]){
     ...
     HOMEKIT_ACCESSORY(.id=6, .category=homekit_accessory_category_switch, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "Switch6"),
            HOMEKIT_CHARACTERISTIC(MANUFACTURER, "Aliyu"),
            HOMEKIT_CHARACTERISTIC(SERIAL_NUMBER, "0123456"),
            HOMEKIT_CHARACTERISTIC(MODEL, "1.0"),
            HOMEKIT_CHARACTERISTIC(FIRMWARE_REVISION, "1.0"),
